...
const Home = () => {
  const socialMediaIcons = [
    {
      icon: faFacebook,
      href: "https://www.facebook.com/profile.php?id=100010232868941",
    },
    {
      icon: faGithub,
      href: "https://github.com/Deepak22448",
    },
    {
      icon: faInstagram,
      href: "https://www.instagram.com/_ds._.7/",
    },
    {
      icon: faLinkedin,
  ...
  useLayoutEffect(() => {
    ...
    const options = {
      strings: ["I'am Deepak Sharma", "I'am a Developer", "I'am a Student"],
      typeSpeed: 50,
      backSpeed: 50,
      showCursor: false,
      loop: true,
