  ...
  const workExperienceData = [
    {
      ...
      body: "Right now i am doing my B.tech in computer science and engineering from St.Martines enigneering college , Hyderabad and learning new things every day.",
    },
    {
      title: "InterMediate",
      duration: "July 2020 - 2022",
      subTitle: "MPC",
      body: "I completed my 12th  standard from Loyola Acedemy Junior College , Alwal , Hyderabad in the year 2022 and secured 83%",
    },
    {
      title: "SSC",
      duration: "July 2019 - 2020",
      subTitle: "School",
      body: "I completed my 10th  standard in Hyderabd from Gowathem Model School , Suchitra in year 2020 and my CGPA was 10.00",
    },
  ];
  return (
