  ...
  const footerData = [
    {
      ...
      body: "I live in Hyderabad , Telangana. ZipCode : 500055. For further details please message me on my social media accounts given above.",
    },
    {
      icon: faMailBulk,
      title: "EMAIL ME",
      body: "Hey need my help ? You can contact Me on my Email : deepaksandeep33@gmail.com It may take a while to reply sometimes but I will help you at any cost",
    },
    {
      icon: faPhone,
      title: "CALL ME AT",
      body: "You can contact me through my Linkedin account .Do not hesitate to ask me for any kind of help.",
    },
  ];
  return (
    <section className="contact bg-black px-4" id="contact">
      ...
      <form
        className="pb-20"
        action="https://formspree.io/f/xdobrdjw"
        method="POST"
      >
